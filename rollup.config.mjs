...
export default [
    ...
    {
        input: ['src/index.ts'],
        output: [{ preserveModules: false, banner, dir: 'build/esm', format: 'esm', entryFileNames: '[name].mjs', sourcemap: true },],
        plugins: [
            replacePlugin,
    ...
    {
        input: ['src/index.ts'],
        output: [{ preserveModules: false, banner, dir: 'build/cjs', format: 'cjs', entryFileNames: '[name].js', sourcemap: true },],
        plugins: [
            replacePlugin,
